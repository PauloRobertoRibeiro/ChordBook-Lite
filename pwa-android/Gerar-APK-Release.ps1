...
& (Join-Path $bt "apksigner.bat") sign --ks $store --ks-key-alias upload --ks-pass "pass:$pass" --key-pass "pass:$pass" --out $releaseApk (Join-Path $out "aligned.apk")
& (Join-Path $bt "apksigner.bat") verify $releaseApk
